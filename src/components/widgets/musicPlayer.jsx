...
/* 
<a href="https://open.spotify.com/album/4LH4d3cOWNNsVw41Gqt2kv?si=nba9ShSoSxGqgMd7MsqANA" target="_blank"></a>
*/
...
export default function MusicPlayer() {
    ...
    return (
        <div className="relative w-full border border-neutral-800/60 bg-neutral-800/10 p-6 rounded-xl flex justify-between group-hover:cursor-pointer group shadow-inner shadow-neutral-400/5" onMouseEnter={() => handleClick(true)} onMouseLeave={() => handleClick(false)}>
